...
class Timeline {
    ...
    animate() {
        ...
        // Katsayı 0.02'ye düşürüldü (Daha yavaş, pürüzsüz kaydırma)
        if (Math.abs(dx) > 0.1) {
    ...
    // --- ODAKLI ZOOM FONKSİYONLARI (GÜNCELLENMİŞ) ---
    ...
    zoomIn(e = null) {
        ...
        // "Dönme" sorununu çözmek için anında geçiş
