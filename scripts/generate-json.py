...
def parse_markdown_file(file_path):
    ...
    # BAŞLIK OLUŞTURMA - Açıklamadan ilk cümleyi al
    if not event.get('title') and event.get('description'):
        event['title'] = extract_title_from_description(event['description'])
        print(f"   📝 Başlık oluşturuldu: {event['title']}")
